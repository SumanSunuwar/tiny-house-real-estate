...
class PropertyPublishedManager(models.Manager):
    """Manager for property model"""
    def get_queryset(self):
        return (
            super(PropertyPublishedManager, self).get_queryset(
...
class Property(TimeStampedUUIDModel):
    ...
    description = models.TextField(
        ...
        default = "Default Description...update this"
    )
    ...
    street_address = models.CharField(
        ...
        max_length = 150,
        default = "PepsiCola Townplanning"
    )
    ...
    published_status = models.BooleanField(
        verbose_name = _("Publushed Status"),
        default = False
    )
