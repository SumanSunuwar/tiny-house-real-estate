    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', django_countries.fields.CountryField(default='NP', max_length=2, verbose_name='Country')),
                ('city', models.CharField(default='Kathmandu', max_length=180, verbose_name='City')),
                ('postal_code', models.CharField(default='42600', max_length=100, verbose_name='Postal Code')),
                ('street_address', models.CharField(default='PepsiCola Townplanning', max_length=150, verbose_name='Street Address')),
                ...
                ('published_status', models.BooleanField(default=False, verbose_name='Publushed Status')),
